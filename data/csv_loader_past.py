    ...
    def _loadTick(self, symbol, files):
        ...
        for f in files:
            ...
            try:
                ...
                df = None
                del df
        df_rtn.columns = ['datetime', 'exchange', 'vtSymbol', 'lastPrice', 'position', 'delta_pos', 'dAmount', 'dVol', 'open_vol', 'close_vol', 'trade_type', 'direction', 'bidPrice1', 'askPrice1', 'bidVolume', 'askVolume']
