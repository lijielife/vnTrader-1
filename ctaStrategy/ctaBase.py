...
STRATEGY_DB_NAME = 'VnTrader_Strategy_Db'
...
class ParkedOrder(object):
    ...
    def __init__(self):
        ...
        self.strategy = None               # 下预埋单的策略对象
        self.localOrderID = EMPTY_STRING   # 预埋单本地编号 
        self.parkedOrderID = EMPTY_STRING
    
    # def __repr__(self):
    #     return '[vtSymbol=%s price=%r volume=%d strategy=%s localOrderID=%s parkedOrderID=%s]' \
    #         %(self.vtSymbol, self.price, self.volume, self.strategy.name, self.localOrderID, self.parkedOrderID)
